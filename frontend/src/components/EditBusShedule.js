...
export default class EditBusDetails extends Component{ 
    ...
    componentDidMount(){
        console.log('=============== prarams', this.props.match);
        axios.get('http://localhost:3001/bus/edit/'+this.props.match.params.id) 
        .then(response=>{
    ...
    onsubmit(e){
        ...
        axios.post('http://localhost:3001/bus/update/'+this.props.match.params.id,obj)
...
<br></br>
        <div className="row">
            ...
            <p className="mainHeader">Edit Bus Shedule</p> */}
            <div
     class='form-group w-25'
     className='shadow p-5'
   ...
   >     
        ...
        <div style={{marginTop:10}}>
          <h3 className = 'header2'> <center>EDIT BUS SHEDULE </center></h3>
...
<td><p>DepartureTime</p><input type="time"  value={this.state.departureTime} onChange={this.onChangeDepartureTime} required></input></td>
  ...
  <tr>
      ...
      <td><p>Kilometers</p><input type="text" placeholder="Enter Kilometers"  value={this.state.kilometers} onChange={this.onChangeKilometers} required></input></td>
      <td><p>Price</p><input type="text" placeholder="Enter Price"  value={this.state.price} onChange={this.onChangePrice} required></input></td>
    </tr>
